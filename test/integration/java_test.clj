...
(deftest java-test
  (testing "mj javac"
    (makejack/sh ["../../target/mj-script" "--verbose" "javac"]
  ...
  (testing "mj compile"
    (makejack/sh ["../../target/mj-script" "--verbose" "compile"]
                 {:dir "test-resources/test_project_java"})
    (let [class-file (util/path
                       "test-resources" "test_project_java"
